...
<div class="row"><h2>Edit Program </h2></div>
</br><div class="row">
<form:form modelAttribute="prog" method="post">
	<b>Program Name : </b>&nbsp;&nbsp;&nbsp; <input  class="textbox" type="text" name="name" value="${prog.name }" style="width: 250px;" placeholder="Program Name" required />
...
<input type="reset" value="clear"  class="btn btn-warning" name="clear">&nbsp;&nbsp;&nbsp;
 <a href="../deleteProgram/${prog.id}.html"><button type="button" name="${prog.id}" value="remove" class="btn btn-danger remove">Delete</button></a>&nbsp;&nbsp;&nbsp;
